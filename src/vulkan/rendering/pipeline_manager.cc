...
/*  /1* rasterizer.polygonMode = VK_POLYGON_MODE_FILL; *1/ */
/*  rasterizer.polygonMode = Flim::renderModeToPolygonMode(renderer.mode); */
/*  /1* rasterizer.polygonMode = VK_POLYGON_MODE_POINT; *1/ */
...
/*  /1* vkDestroyRenderPass(context.device, pipeline.renderPass, nullptr); *1/ */
/*} */
