...
/*   /1* std::array<VkAttachmentDescription, 2> attachments = {colorAttachment, *1/ */
/*   /1*                                                       depthAttachment}; *1/ */
/*   /1* VkRenderPassCreateInfo renderPassInfo{}; *1/ */
/*   /1* renderPassInfo.sType = VK_STRUCTURE_TYPE_RENDER_PASS_CREATE_INFO; *1/ */
/*   /1* renderPassInfo.attachmentCount = static_cast<uint32_t>(attachments.size()); *1/ */
/*   /1* renderPassInfo.pAttachments = attachments.data(); *1/ */
/*   /1* renderPassInfo.subpassCount = 1; *1/ */
/*   /1* renderPassInfo.pSubpasses = &subpass; *1/ */
/*   /1* renderPassInfo.dependencyCount = 1; *1/ */
/*   /1* renderPassInfo.pDependencies = &dependency; *1/ */

/*   /1* if (vkCreateRenderPass(context.device, &renderPassInfo, nullptr, *1/ */
/*   /1*                        &pipeline.renderPass) != VK_SUCCESS) { *1/ */
/*   /1*   throw std::runtime_error("failed to create render pass!"); *1/ */
/*   /1* } *1/ */
/* } */
