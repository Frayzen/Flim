...
/*     Mesh mesh = MeshUtils::loadFromFile("./myfile.obj"); // or other */
...
/*     // explanations */
/*     scene.registerMesh(mesh, RenderParams::DefaultRenderParams()); */
...
/*       (void)deltaTime; */
/*       (void)mesh.getTriangles(); // returns kokkos view */
/*     }); */
/*   } */
/*   Kokkos::finalize(); */
/*   return 0; */
