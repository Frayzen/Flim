...
void FreeCameraObject::handleInputs2D(double deltaTime) {
  (void)deltaTime;
...
void FreeCameraObject::handleInputs3D(double deltaTime) {
...
void FreeCameraObject::handleInputs(double deltaTime) {
  if (is2D)
